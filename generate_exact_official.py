...
![Status](https://img.shields.io/badge/Status-Completed-brightgreen) ![Pertemuan](https://img.shields.io/badge/Penyajian-Ke--{m['no']}-blue) ![Waktu](https://img.shields.io/badge/Total_Waktu-180_Menit-green)
...
| Parameter | Detail |
| :--- | :--- |
| **Unit Kompetensi** | {m['unit']} — {m['unit_title']} (72 JP) |
...
| **2** | **Penyajian Konsep** | 35' | {s1_text} | {m['sub1_media']} |
| **3** | **Demonstrasi Instruktur** | 35' | {s2_text} | {m['sub2_media']} |
| **4** | **Praktik Mandiri** | 35' | {s3_text} | {m['sub3_media']} |
...
| **8** | **Tugas Tambahan & Penutup** | 10' | {m['tugas']}<br>- Kebersihan lab (*5R*) & Doa Penutup | Form Pengumpulan |

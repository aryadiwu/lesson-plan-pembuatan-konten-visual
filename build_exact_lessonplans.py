...
def make_md_content(m):
    sub1_u = m['sub1_uraian'].replace('\n', '<br>')
    sub2_u = m['sub2_uraian'].replace('\n', '<br>')
    sub3_u = m['sub3_uraian'].replace('\n', '<br>')
    no_str = f"{m['no']:02d}"
...
| Parameter | Detail |
| :--- | :--- |
| **Unit Kompetensi** | {m['unit']} — {m['unit_title']} |
...
| :-: | :--- | :-: | :--- | :--- |
| **1** | **Pendahuluan** | 10' | {m['pendahuluan_text'].replace('\n', '<br>')} | Slide PPT, Projector |
| **2** | **Penyajian 1: {m['sub1_judul']}** | 35' | {sub1_u} | {m['sub1_media']} |
| **3** | **Penyajian 2: {m['sub2_judul']}** | 35' | {sub2_u} | {m['sub2_media']} |
| **4** | **Penyajian 3: {m['sub3_judul']}** | 35' | {sub3_u} | {m['sub3_media']} |
...
| **8** | **Tugas & Penutup** | 10' | {m['tugas']}<br>- Merapikan perangkat PC/HP & ruang kelas (5R)<br>- Berdoa dan salam penutup | Form / Papan Tulis |
...
def generate_docx(m):
    ...
    with open(md_path, 'w', encoding='utf-8') as f:\n        f.write(make_md_content(m))\n\n    print(f"Strict Template Generated: Pertemuan {no_str}")

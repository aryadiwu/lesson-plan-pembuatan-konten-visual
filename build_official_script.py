...
| **Lokasi / Tanggal** | BPVP Belitung / Agustus 2026 |
...
| :-: | :--- | :-: | :--- | :--- |
| **1** | **Pendahuluan** | 10' | {p_text} | Slide PPT, Projector |
| **2** | **Penyajian Konsep 1: {m['sub1_judul']}** | 35' | {s1_text} | {m['sub1_media']} |
| **3** | **Penyajian Konsep 2: {m['sub2_judul']}** | 35' | {s2_text} | {m['sub2_media']} |
| **4** | **Praktik Mandiri: {m['sub3_judul']}** | 35' | {s3_text} | {m['sub3_media']} |
| **5** | **Kesimpulan** | 5' | {m['kesimpulan']} | {m['kesimpulan_media']} |
| **6** | **Aplikasi & Kuis** | 20' | {m['aplikasi']} | {m['aplikasi_media']} |
| **7** | **Evaluasi (Jobsheet)** | 30' | {m['evaluasi']} | {m['evaluasi_media']} |
| **8** | **Tugas & Penutup** | 10' | {m['tugas']}<br>- Merapikan perangkat PC/HP & ruang lab (5R)<br>- Berdoa dan salam penutup | Form Pengumpulan / Papan |

---

*Pengesahan: Belitung, Agustus 2026 — Instruktur: Arry Trie Adhytia*
"""
...
def generate_docx(m):
    ...
    with open(md_path, "w", encoding="utf-8") as f:\n        f.write(make_md_content(m))\n\n    print(f"Generated Meeting {no_str} (DOCX & MD) using Master Template Format")

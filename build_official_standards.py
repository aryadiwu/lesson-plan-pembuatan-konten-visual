...
all_meetings = [
    {
        ...
        "media_list": "Media Power Point Gambar dan Video",
        "alat_list": "Alat Proyektor dan Layar Perangkat Komputer / HP Papan Tulis, Spidol dan Penghapus",
        "bahan_list": "Flashdisk Modul Pengantar Content Creator Form Test Hari 01",
        "persiapan": "Persiapan ruangan laboratorium / kelas\nPersiapan alat peraga & file presentasi",
        "pendahuluan_text": "1. Memberi salam dan Memperkenalkan diri\n2. Mengabsen peserta pelatihan\n3. Menjelaskan safety induction dan rules\n4. Mengadakan apersepsi industri media sosial\n5. Menyampaikan judul & tujuan belajar",
        "sub1_judul": "Pengenalan Profesi & Karakteristik Platform",
        "sub1_uraian": "Instruktur menjelaskan kepada peserta terkait:\n- Definisi dan peran Content Creator di industri kreatif\n- Karakteristik platform: Instagram, TikTok, YouTube, dan LinkedIn\n- Algoritma dasar dan pola konsumsi konten visual audiens\nInstruktur memberikan kesempatan peserta untuk bertanya.",
        "sub1_media": "Power Point Gambar dan Video",
        "sub1_waktu": "35 menit",
        "sub2_judul": "Etika, Copyright, & Anatomi Konten Visual",
        "sub2_uraian": "Instruktur menjelaskan kepada peserta terkait:\n- Etika dalam pembuatan konten dan lisensi aset (Fair Use, CC0, Copyright)\n- Anatomi konten visual: Hook, Body, dan Call-to-Action (CTA)\n- Tanya jawab interaktif bersama peserta.",
        "sub2_media": "Power Point & Contoh Konten",
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Audit Akun Creator & Identifikasi Konten",
        "sub3_uraian": "Instruktur memberikan jobsheet dan mendampingi peserta untuk:\n- Mengidentifikasi 3 akun creator sukses berdasarkan pilar kontennya\n- Menganalisis elemen visual Hook & CTA yang digunakan\n- Instruktur berkeliling memberikan bimbingan.",
        "sub3_media": "Lembar Jobsheet 01 & Perangkat HP/PC",
        "sub3_waktu": "35 menit",
        "kesimpulan": "Instruktur menyimpulkan profesi content creator membutuhkan pemahaman platform, etika hak cipta, dan struktur visual yang konsisten.",
        "kesimpulan_media": "Power Point",
        "aplikasi": "Instruktur memberikan kuis evaluasi singkat mengenai etika hak cipta dan karakteristik platform.",
        "aplikasi_media": "Form / Quizizz",
        "evaluasi": "Instruktur menilai hasil identifikasi audit akun creator peserta sesuai Jobsheet 01.",
        "evaluasi_media": "Lembar Jobsheet 01",
        "tugas": "Instruktur memberikan tugas tambahan: Mencari 1 contoh konten viral dan menganalisis struktur visual Hook-nya."
    },
    {
        "no": 2,
        ...
        "metode": "Ceramah Praktikum Diskusi",
        "media_list": "Media Power Point Contoh Foto Produk & Lighting",
        ...
        "persiapan": "Persiapan mini studio foto / area pencahayaan\nPersiapan alat peraga foto produk",
        "pendahuluan_text": "1. Memberi salam dan Memperkenalkan diri\n2. Mengabsen peserta pelatihan\n3. Menjelaskan safety induction penggunaan peralatan\n4. Apersepsi: Dampak foto produk jernih vs foto buram pada penjualan\n5. Menyampaikan judul & tujuan belajar",
        "sub1_judul": "Pengaturan Kamera HP & Komposisi Foto",
        "sub1_uraian": "Instruktur menjelaskan kepada peserta terkait:\n- Pengaturan fokus, exposure lock, gridlines, dan HDR di HP\n- Prinsip komposisi: Rule of Thirds, Leading Lines, Framing, & Flatlay\n- Pencahayaan alami (Window Light) vs pencahayaan buatan\nInstruktur memberikan kesempatan peserta untuk bertanya.",
        "sub1_media": "Power Point & Smartphone Master",
        "sub1_waktu": "35 menit",
        "sub2_judul": "Demonstrasi Angle & Lighting Setup",
        "sub2_uraian": "Instruktur mendemonstrasikan kepada peserta terkait:\n- Pengambilan foto angle Eye Level, High Angle, Low Angle, dan Top-Down\n- Pengaturan arah cahaya utama (Key Light) dan pemantul (Reflector)\n- Tanya jawab interaktif bersama peserta.",
        "sub2_media": "Lighting Studio & Objek Produk",
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Foto Produk / Lifestyle dengan HP",
        "sub3_uraian": "Instruktur memberikan jobsheet dan mendampingi peserta untuk:\n- Mengambil minimal 3 variasi foto produk dengan komposisi & angle berbeda\n- Mengatur lighting agar tidak terdapat bayangan keras\n- Instruktur berkeliling memberikan umpan balik langsung.",
        "sub3_media": "Smartphone Peserta & Jobsheet 02",
        "sub3_waktu": "35 menit",
        "kesimpulan": "Instruktur menyimpulkan bahwa foto HP berkualitas ditentukan oleh kontrol cahaya, komposisi yang tepat, dan kebersihan lensa.",
        "kesimpulan_media": "Power Point",
        "aplikasi": "Instruktur memberikan kuis tebak komposisi dan angle dari gambar sampel.",
        "aplikasi_media": "Form / Quizizz",
        "evaluasi": "Instruktur menilai 3 karya foto produk HP peserta berdasarkan rubrik Jobsheet 02.",
        "evaluasi_media": "Lembar Jobsheet 02",
        "tugas": "Instruktur memberikan tugas tambahan: Mengambil 1 foto flatlay makanan/produk lokal di rumah dengan cahaya alami."
    },
    {
        "no": 3,
        ...
        "metode": "Ceramah Praktikum Diskusi",
        "media_list": "Media Power Point Video Contoh Pergerakan Kamera",
        "alat_list": "Alat Proyektor dan Layar Smartphone Tripod Gimbal Stabilizer Papan Tulis",
        "bahan_list": "Flashdisk Modul Sinematografi HP Shotlist Template",
        "persiapan": "Persiapan area praktik video shooting\nPersiapan alat stabilizer & tripod",
        "pendahuluan_text": "1. Memberi salam dan Memperkenalkan diri\n2. Mengabsen peserta pelatihan\n3. Menjelaskan safety induction pergerakan kamera\n4. Apersepsi: Mengapa video Reels/TikTok butuh variasi shot dinamis\n5. Menyampaikan judul & tujuan belajar",
        "sub1_judul": "Dasar Sinematografi HP & Variasi Shot",
        "sub1_uraian": "Instruktur menjelaskan kepada peserta terkait:\n- Resolusi video (1080p vs 4K) dan Frame Rate (24fps, 30fps, 60fps)\n- Variasi jenis shot: Wide Shot, Medium Shot, Close-Up, dan Extreme Close-Up\n- Perbedaan A-Roll (Subjek Utama) dan B-Roll (Video Pendukung)\nInstruktur membuka sesi tanya jawab.",
        "sub1_media": "Power Point & Video Sample",
        "sub1_waktu": "35 menit",
        "sub2_judul": "Teknik Pergerakan Kamera & Stabilisasi",
        "sub2_uraian": "Instruktur mendemonstrasikan kepada peserta terkait:\n- Teknik Panning, Tilting, Dolly In/Out, dan Orbit shot menggunakan tangan (Handheld)\n- Penggunaan Tripod dan Gimbal Stabilizer untuk pergerakan halus\n- Tanya jawab interaktif bersama peserta.",
        "sub2_media": "Gimbal & Smartphone Master",
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Shooting B-Roll Video Pendek",
        ...
        "sub3_waktu": "35 menit",
        "kesimpulan": "Instruktur menyimpulkan variasi shot dan pergerakan kamera yang stabil adalah kunci video pendek yang tidak membosankan.",
        "kesimpulan_media": "Power Point",
        "aplikasi": "Instruktur memberikan pertanyaan seputar penentuan frame rate dan jenis shot yang sesuai skenario.",
        "aplikasi_media": "Form / Quizizz",
        "evaluasi": "Instruktur menilai 5 klip B-Roll peserta berdasarkan kejelasan fokus dan kestabilan gerakan.",
        "evaluasi_media": "Lembar Jobsheet 03",
    ...
    },
    {
        ...
        "metode": "Ceramah Praktikum Diskusi",
        "media_list": "Media Power Point Contoh Caption Viral & Headline Iklan",
        "alat_list": "Alat Proyektor dan Layar Perangkat Komputer / HP Papan Tulis",
        "bahan_list": "Flashdisk Modul Copywriting Lembar Kerja Copywriting (Jobsheet 04)",
        "persiapan": "Persiapan slide formula copywriting\nPersiapan sampel caption berbagai brand",
        "pendahuluan_text": "1. Memberi salam dan Memperkenalkan diri\n2. Mengabsen peserta pelatihan\n3. Menjelaskan safety induction & aturan kelas\n4. Apersepsi: Pentingnya 3 detik pertama (Hook) agar audiens tidak melakukan swipe-away\n5. Menyampaikan judul & tujuan belajar",
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Penulisan Naskah Copywriting",
        ...
        "sub3_media": "PC / Lembar Jobsheet 04",
        "sub3_waktu": "35 menit",
        ...
        "evaluasi_media": "Lembar Jobsheet 04",
    ...
    },
    {
        ...
        "bahan_list": "Flashdisk Modul Design Thinking Lembar Kerja Persona",
        "persiapan": "Persiapan meja kelompok workshop\nPersiapan perlengkapan sticky notes & papan ideasi",
        "pendahuluan_text": "1. Memberi salam dan Memperkenalkan diri\n2. Mengabsen peserta pelatihan\n3. Menjelaskan safety induction & dinamika kelompok\n4. Apersepsi: Mengapa konten yang bagus sering gagal karena tidak sesuai kebutuhan audiens\n5. Menyampaikan judul & tujuan belajar",
        "sub1_judul": "Konsep Design Thinking & User Persona",
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Workshop Ideasi Konten Berkelompok",
        ...
        "sub3_waktu": "35 menit",
        "kesimpulan": "Instruktur menyimpulkan bahwa Design Thinking memastikan setiap konten yang dibuat memiliki tujuan dan menjawab kebutuhan audiens.",
        "kesimpulan_media": "Power Point",
        ...
        "evaluasi_media": "Lembar Kerja 05",
    ...
    },
    {
        ...
        "evaluasi_media": "Lembar Jobsheet 06",
    ...
    },
    {
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Membuat Brand Kit & Template Desain Canva",
        ...
        "evaluasi_media": "Lembar Jobsheet 07",
    ...
    },
    {
        ...
        "sub2_media": "Canva App & Screen Projector",
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Mendesain 5-Slide Seamless Carousel",
        ...
        "evaluasi_media": "Lembar Jobsheet 08",
    ...
    },
    {
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik & Uji Praktik Prototipe Narasi Visual",
        ...
        "evaluasi_media": "Lembar Test Praktik 09",
    ...
    },
    {
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Editing Video Pendek (Rough Cut ke Fine Cut)",
        ...
        "evaluasi_media": "Lembar Jobsheet 11",
    ...
    },
    {
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Penerapan Keyframe & SFX pada Video",
        ...
        "evaluasi_media": "Lembar Jobsheet 12",
    ...
    },
    {
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Integrasi Aset & Ekspor Final Video",
        ...
        "evaluasi_media": "Lembar Jobsheet 13",
    ...
    },
    {
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Membuat Halaman Link-in-Bio & Aset Promosi",
        ...
        "evaluasi_media": "Lembar Jobsheet 14",
    ...
    },
    {
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Menyusun Kalender Konten Bulanan",
        ...
        "evaluasi_media": "Lembar Jobsheet 15",
    ...
    },
    {
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Penulisan Caption SEO & Naskah Email",
        ...
        "evaluasi_media": "Lembar Jobsheet 16",
    ...
    },
    {
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Penulisan Prompt AI Copywriting & Storyboard",
        ...
        "evaluasi_media": "Lembar Jobsheet 17",
    ...
    },
    {
        ...
        "sub2_waktu": "35 menit",
        "sub3_judul": "Praktik Finishing & Pengunggahan Berkas Portofolio",
...
def make_md(m):
    no_str = f"{m['no']:02d}"
    s1 = m['sub1_uraian'].replace('\n', '<br>')
    s2 = m['sub2_uraian'].replace('\n', '<br>')
    s3 = m['sub3_uraian'].replace('\n', '<br>')
    p_text = m['pendahuluan_text'].replace('\n', '<br>')
    
    return f"""# 📚 LESSON PLAN (Rencana Penyajian)
> **Program Pelatihan:** Pembuatan Konten Visual untuk Media Sosial  
> **Kejuruan:** TIK | **Unit Kompetensi:** {m['unit']} - {m['unit_title']}  
...
| Parameter | Detail |
| :--- | :--- |
| **Nama Program Pelatihan** | Pembuatan Konten Visual untuk Media Sosial |
| **Kejuruan** | Teknologi Informasi dan Komunikasi (TIK) |
| **Kode Unit Kompetensi** | {m['unit']} |
| **Judul Unit Kompetensi** | {m['unit_title']} |
| **Penyajian Ke-** | {no_str} dari 20 |
| **Judul Materi** | **{m['judul']}** |
| **Waktu** | 180 menit (4 JP) |
| **Instruktur** | Arry Trie Adhytia |
| **Lokasi / Tanggal** | Belitung, Agustus 2026 |
...
## 🛠️ Metode & Media Pembelajaran
- **Metode Mengajar:** {m['metode']}
- **Media Pembelajaran:** {m['media_list']}
- **Alat Pembelajaran:** {m['alat_list']}
- **Bahan Pembelajaran:** {m['bahan_list']}

---

## ⏱️ Langkah-Langkah Pembelajaran (180 Menit)

### A. Persiapan
{m['persiapan']}

### B. Tabel Alur Penyajian

| Tahapan | Sub Judul / Topik | Uraian Kegiatan | Media & Alat | Waktu |
| :--- | :--- | :--- | :--- | :---: |
| **Pendahuluan** | Pengantar Sesi | {p_text} | Projector / PPT | 10 menit |
| **Penyajian 1** | {m['sub1_judul']} | {s1} | {m['sub1_media']} | {m['sub1_waktu']} |
| **Penyajian 2** | {m['sub2_judul']} | {s2} | {m['sub2_media']} | {m['sub2_waktu']} |
| **Penyajian 3** | {m['sub3_judul']} | {s3} | {m['sub3_media']} | {m['sub3_waktu']} |
| **Kesimpulan** | Summary Materi | {m['kesimpulan']} | {m['kesimpulan_media']} | 5 menit |
| **Aplikasi** | Kuis Pemahaman | {m['aplikasi']} | {m['aplikasi_media']} | 20 menit |
| **Evaluasi** | Penilaian Jobsheet | {m['evaluasi']} | {m['evaluasi_media']} | 30 menit |
| **Tugas Tambahan** | Tugas Rumah | {m['tugas']} | Form / Papan Tulis | 5 menit |
| **Pemberesan** | Pemberesan Kelas | Merapikan perangkat PC/HP dan ruang lab (5R), berdoa, dan salam penutup | Area Lab | 5 menit |

---
*Instruktur: Arry Trie Adhytia (Belitung, Agustus 2026)*
"""
...
def make_docx(m):
    ...
    with open(md_path, "w", encoding="utf-8") as f:\n        f.write(make_md(m))\n\n    print(f"Generated strict template for Pertemuan {no_str}")

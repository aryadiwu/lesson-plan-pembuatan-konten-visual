...
def make_md_content(m):
    ...
    out += f"> **Kejuruan:** TIK | **Unit Kompetensi:** {m['unit']} — {m['unit_title']}  \n\n"
    out += f"![Status](https://img.shields.io/badge/Status-Completed-brightgreen) ![Pertemuan](https://img.shields.io/badge/Penyajian-Ke--{m['no']}-blue) ![Waktu](https://img.shields.io/badge/Total_Waktu-180_Menit-green)\n\n"
    out += "---\n\n"
    out += "## 📌 Metadata Pelatihan\n\n"
    out += "| Parameter | Detail |\n"
    out += "| :--- | :--- |\n"
    out += f"| **Unit Kompetensi** | {m['unit']} — {m['unit_title']} (72 JP) |\n"
    out += f"| **Penyajian Ke-** | {m['no']} dari 20 |\n"
    out += f"| **Judul Materi** | **{m['judul']}** |\n"
    out += "| **Alokasi Waktu** | 180 Menit |\n"
    out += "| **Instruktur** | Arry Trie Adhytia |\n"
    out += "| **Lokasi / Tanggal** | BPVP Belitung / Agustus 2026 |\n\n"
    out += "---\n\n"
    out += "## 🎯 Tujuan & Manfaat\n\n"
    out += "> [!NOTE]\n"
